...
################################################################################
## /_posts/2015-05-16-Interactively-Cluster-Your-Data:-A-Shiny-App.Rmd
## Short Summary: Describe clustering Shiny App
...
```{r outputPanels, eval=FALSE, echo=TRUE}
...
```{r outputPanels2, eval=FALSE, echo=TRUE}
